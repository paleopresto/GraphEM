...
class GraphEM(object):
	...
	temp_r: reconstructed temperature field
	proxy_r: reconstructed proxy field
	...
	EM: Implementation of the EM algorithm with a Gaussian graphical model
	fit_Sigma: Used to estimate the covariance matrix of the Gaussian graphical model
	bootstrap: Perform multiple reconstructions via block bootstrap
	'''
	...
	def fit(self, temp, proxy, calib, graph = [], lonlat = [], sp_TT=3.0, sp_TP=3.0, sp_PP=3.0, N_graph=30, C0=[], M0=[], maxit=200, bootstrap = False, N_boot = 20, distance = 1000, graph_method = 'neighborhood', estimate_graph = True, save_graphs = False):
		''' 
